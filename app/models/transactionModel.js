...
class transaction {
  ...
  static async getTransactions(UserID='admin'){
    try {
  ...
  static async calculateTotalBalance(transactions){
    let totalBalance = 0;
  ...
  static async createTransaction(type, amount, date, categoryId, description, userId){
    try {
  ...
  static async updateTransaction(id, newTransaction){
  ...
  static async getTransactionsbyCategory(id){
